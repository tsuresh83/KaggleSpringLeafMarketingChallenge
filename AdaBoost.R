...
ncores <- ifelse(nodename=="bigtumor",50,
...
print(Sys.time())
model <- train(target~., data=sampleTraining, method="AdaBag", trControl=control,metric="ROC",tuneGrid=expand.grid(mfinal=seq(100,1500,50),maxdepth=seq(25,30,1)))
